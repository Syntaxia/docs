...
The Pipedrive connector links a Pipedrive company account to Syntaxia. Use it to bring sales pipeline data, including organizations, persons, deals, activities, and users, into your golden layer.
...
<Steps>
  <Step title="Add the source">
    From Source Management in the Data pillar, click **Add Source**, expand the **Pipedrive** card, and enter a connection label like `Pipedrive - SDR Team`.
  </Step>
