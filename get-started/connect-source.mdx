...
A **source** is one of your CRMs, like Salesforce or HubSpot, plugged into Syntaxia. Most sources connect through OAuth: you authorize the connection, name it, and let the first sync run. If you have a Salesforce export zip instead of connector access, you can [upload it](/guide/connectors/crm-export-upload) and skip OAuth entirely. Once the source card on your command center turns green, you are ready to discover an ontology.
